...
R"=====(  
    ...
    <head>
      ...
      <body>
        ...
        <div id="counterDisplay">Abstand: <span id="counter"> Lade...</span></div>
    ...
    <script>
          ...
          document.addEventListener("keydown", function(event) {
              switch(event.key) {
                  ...
                  case 'd':
                      ...
                      break;
                  case 'ArrowUp':  // Handle up arrow key press
                      if (!keysPressed.up) {
                          keysPressed.up = true;
                          updateMovement(event);
                      }
                      break;
                  case 'ArrowDown':  // Handle down arrow key press
                      if (!keysPressed.down) {
          ...
          document.addEventListener("keyup", function(event) {
              switch(event.key) {
                  ...
                  case 'd':
                      ...
                      updateMovement(event);
                      break;
                  case 'ArrowUp':  // Handle up arrow key release
                      keysPressed.up = false;
                      updateMovement(event);
                      break;
                  case 'ArrowDown':  // Handle down arrow key release
          ...
          setInterval(updateCounter, 1000);  // Alle 1000ms wiederholen
      </script>
      </body>
</html>
)=====";
