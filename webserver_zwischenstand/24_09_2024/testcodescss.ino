...
void setup() {
  ...
  server.on("/api/buttontest/b1", handleButton1);
  server.on("/api/buttontest/b2", handleButton2);
  server.on("/api/buttontest/b3", handleButton3);
  server.on("/api/buttontest/b4", handleButton4);
